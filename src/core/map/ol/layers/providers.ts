...
export type TileProvider = {
    ...
    variants?: {
        [key: string]: TileProviderVariant
    }
}
...
export type TileProviderVariant =
    | string
    | {
          url?: string | Function
          options?: TileProviderOptions
...
const providers: TileProviders = {
        ...
        variants: {
            Roads: {
                options: {
                    variant: "roads",
                    attribution:
                        "{attribution.OpenMapSurfer}{attribution.OpenStreetMap}",
                },
            },
            Hybrid: {
                options: {
    ...
    LINZ: {
        ...
        variants: {
            ...
            nz_topo50_maps: {
                options: {
                    attribution:
                        'Sourced from the <a href="https://data.linz.govt.nz/">LINZ Data Service</a> and licensed for reuse under the <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a> license',
                    variant: "layer=50767",
                    tilematrixset: "EPSG:3857",
                    maxZoom: 22,
                    maxNativeZoom: 22,
    ...
    PDOK: {
        ...
        options: {
            attribution:
                '<a href="https://www.pdok.nl/introductie?articleid=1949876">BRT Achtergrondkaart</a> by ' +
        ...
        variants: {
            ...
            luchtfotoRGB: {
                ...
                options: {
                    ...
                    attribution:
                        '<a href="https://www.pdok.nl/introductie?articleid=1954278">Luchtfoto Actueel Ortho 25cm RGB</a> ' +
            ...
            luchtfotoIR: {
                ...
                options: {
                    ...
                    attribution:
                        '<a href="https://www.pdok.nl/introductie?articleid=1954278">Luchtfoto Actueel Ortho 25cm Infrarood</a> ' +
                        'by <a href="http://www.beeldmateriaal.nl">Beeldmateriaal.nl</a>, <a href="http://creativecommons.org/licenses/by/4.0">CC BY 4.0</a>',
                },
            },
        },
